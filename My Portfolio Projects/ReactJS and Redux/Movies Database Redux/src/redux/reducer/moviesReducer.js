        ...
        switch(action.type ) {
            ...
            case moviesType :
                ...
                // using the imported variable of the first object's property {movies array} of initial value of the reducer state prop  :      
                   // assigingnig the parmaters of reducer by the recivied  values from the action methods [i will use fixed value of {pageCount} ] :
                // return { movies :  action.data  , pageCount: action.pages }
                return { movies :  action.data  , pageCount: 500 }
