...
function myTest() {
  ...
  function defAssignElemMap() {
    ...
    // A] Assigning new [[Single value]] to the [Map object] using {Set()} Method :
     
      // 1) By using Set() [Assign element to the Defined Map object] :
        myMap.set('Name' , 'shadi') ;   
      
      // 2) By using Set() with definition [Assign element while definiton map object ] :
        let myMap1 = new Map() ; 
        myMap1.set('username', 'Shadi');  
      // ===============================================
