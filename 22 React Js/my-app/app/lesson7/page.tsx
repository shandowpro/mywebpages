//  Child page of [lesson7 : '7 conditaional Rendering with Including Compoenents' ]
...
function lesson7() {
  return (
     <>
        <header style={{color:"blue" , fontSize:"50px" , border:"solid red 3px", marginBottom:"10px" }}> Welcome to Lesson7 :  conditaional Rendering with Including Compoenents </header>
