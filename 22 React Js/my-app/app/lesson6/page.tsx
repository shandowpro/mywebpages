//  Child page of [lesson6 : '6 Arrange Syntax of page.tsx  with other children components' ]
...
function lesson6() {
  return (
     <>
         <header style={{color:"blue" , fontSize:"50px" , border:"solid red 3px", marginBottom:"10px" }}> Welcome to Lesson6 :  Arrange Syntax of page.tsx  with other children components </header>
        ...
        <ul style={{ border:"solid red 3px", margin:"10px" , padding:"5px"  }}> 
            <li> <Link href="/"> Go to Main Home page </Link>  </li>
