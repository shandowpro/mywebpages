//  Child page of [lesson8 : '8 Styling in ReactJS' ]
...
function lesson8() {
  return (
     <>
         <header style={{color:"blue" , fontSize:"50px" , border:"solid red 3px", marginBottom:"10px" }}> Welcome to Lesson8 :  Styling in ReactJS </header>
