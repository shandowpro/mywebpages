...
//  Child inner page of [lesson5 : '5 using props or Params and type object with children components' ]
...
function lesson5() {
  return (
     <>
        <header style={{color:"blue" , fontSize:"50px" , border:"solid red 3px", marginBottom:"10px" }}> Welcome to Lesson5 :  using props or Params and type object with children components </header>
