//  Child page of [lesson10 : '10 Hocks and useState in ReactJS' ]
...
/*  Application concepts and features :
  -- Applying (2) types of calculations :
  --- 1) Single arithmetic operations => 
  ----- [addition , substration , multiply ,division] to the main value of the same number {by 1}       
  ----- Will use the same number variable handler parameter [as result] inside a special function -> to call the variable itself
  
  --- 2) Accumulated arithmetic operations => 
  ----- [addition , substration , multiply ,division] for the both numbers values        
  ----- Will use another number variable handler parameter [as result] inside a special function -> to call the other variables 
 */
...
function lesson10() {
    ...
    // Defining the processes functions for acculataed arithmetic operations :
  ...
  // A] {Single Numbers} arithmetic operations :
    ...
    // First Number operations : 
      ...
      // 4) Single arithmetic operations [division] for the first Define variable [counter1] ,by using it's dealer function [setCounter1{}]:
        const div1 = () =>{
          setCounter1(counter1 / 1) ; 
        }  
    ...
    // Second Number operations : 
      // 1) Single arithmetic operations [addition] for the second Define variable, by using it's dealer/setter function [setCounter2{}]:
        const add2 = () =>{
          setCounter2(counter2 + 1) ; 
        }  

      // 2) Single arithmetic operations [substraction] for the second Define variable ,by using it's dealer/setter function [setCounter2{}]:
        const sub2 = () =>{
          setCounter2(counter2 - 1) ; 
        }  

      // 3) Single arithmetic operations [multiplay] for the second Define variable ,by using it's dealer/setter function [setCounter2{}]:
        const mult2 = () =>{
          setCounter2(counter2 * 1) ; 
        }  
        
      // 4) Single arithmetic operations [division] for the second Define variable ,by using it's dealer/setter function [setCounter2{}]:
        const div2 = () =>{
          setCounter2(counter2 / 1) ; 
        }  
  ...
  // B] {Both Numbers} arithmetic operations  :
    ...
    // Define the function of handling/using [ division -> First var / Second var]  : 
      const divison  = () =>{
   ...
   return (
     <>
        <header style={{color:"blue" , fontSize:"50px" , border:"solid red 3px", marginBottom:"10px" , textAlign:"center" }}> 
          Welcome to Lesson10 :  Hocks and useState in ReactJS      
        </header>
        ...
        <h1 style={{color:"green"}} > Lesson 10 Application "Using 'useState' Application" :  </h1>
      ...
      <div style={{ textAlign:"center", border:"solid red 3px" , padding:"5px", margin:"5px", width:"100%" }} >
        ...
        <h3 style={{color:"blue" , marginBottom:"10px"}} >  All Numbers operations  </h3>
        ...
        {/* All Numbers Devision process button  */}
        <button onClick={divison}> Devision Process </button>
        <br></br>
        <br></br>
      </div>
      ...
      <div style={{ textAlign:"center", border:"solid red 3px" , padding:"5px", margin:"5px", width:"100%" }} >
        ...
        <h3 style={{color:"blue", marginBottom:"10px"}} >  Results of All Numbers operations   </h3>
        
        {/* Display the Addition Live Result  */}
        <label> Addition Result =  {addResult} </label>  
        <br></br> 
        <br></br> 

        {/* Display the Substracton Live Result  */}
        <label> Substracton Result =  {subResult} </label>  
        <br></br> 
        <br></br> 

        {/* Display the Mutiple Live Result  */}
        <label> Multiple Result =  {multResult} </label>  
        <br></br> 
        <br></br> 

        {/* Display the Devision Live Result  */}
        <label> Devision Result =  {divResult} </label>  
        <br></br> 
        <br></br> 
