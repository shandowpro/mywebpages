//  Child page of [lesson3 : '3 Initializing ReactJS App by VScode ' ]
...
function lesson3() {
  return (
     <>
         <header style={{color:"blue" , fontSize:"50px" , border:"solid red 3px", marginBottom:"10px" }}> Welcome to Lesson3 :  Initializing ReactJS App by VScode </header>
