//  Child page of [lesson9 : '9 Routers and Routing  in ReactJS' ]
...
function lesson9() {
  return (
     <>
         <header style={{color:"blue", fontSize:"50px", border:"solid red 3px", marginBottom:"10px" }}> Welcome to Lesson9 : Routers and Routing  in ReactJS </header>
        ...
        <br></br>
         ...
         <h1 style={{color:"green"}}> Links of current course lessons :  </h1>
         <ul style={{ border:"solid red 3px", margin:"10px" , padding:"5px"  }}> 
