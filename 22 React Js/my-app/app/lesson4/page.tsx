//  Child page of [lesson4 : '4 Main ReatJS Syntax with page.tsx file' ]
...
function lesson4() {
  return (
     <>
        <header style={{color:"blue" , fontSize:"50px" , border:"solid red 3px", marginBottom:"10px" }}> Welcome to Lesson4 :  Main ReatJS Syntax with page.tsx file </header>
