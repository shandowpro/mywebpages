...
function App() {
 // The first funcion of [getting all movies data] has been moved into the {redux/actions/MoviesList.js} by using the redux system  
  ...
  // -----------------
  // The Third funcion of  [get current page's count] according to the retnred value of api value {data.total_pages} according to parameter [page] come from pagination component   
  // -------------------
