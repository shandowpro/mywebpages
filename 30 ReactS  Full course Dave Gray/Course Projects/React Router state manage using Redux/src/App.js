...
function App() {
  ...
  // 2 -  Define a [setStates] as extreacted setState function  from the imported {useStoreActions} class of [easy-peasy]   : 
  ...
  // 3- [First crud operation] : {Fetching data} using custom hook {useAxiosFetch} fetching method (will be used )  =>
  useEffect(() => {
    setPosts(data)
  }, [data, setPosts])
  // -----------------------------------------------
