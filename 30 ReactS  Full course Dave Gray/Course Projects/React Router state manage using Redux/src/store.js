...
/* A] Importings required for using  [easy-peasy] for [redux] configurations handling , as folloowing  : 
  1-  {createStore} :  for define the main function    
  2-  {action} :  for define actions      
  3-  {thunk} :   supporting the tha async actions    
  4-  {computed} : for computing the values of states 
 /
*/
...
export default createStore({
  // 1] Define the main store state and state actions of main state and it's setter functions  :
   ...
   // 2]  Define the custom Store state and Store  actions    :
    ...
    */
    ...
    /* b] Define a Store action  [computed method] of :
      function of getting [post] by using the obtained {id} as main function paramter with find looping statement 
    ...
    */
    ...
    /* c] Define a Store action property [thunk action] of :
    ...
    */
    ...
    // d] Define [deletePost thunk action] a property of action method using thunk for async actions :
    ...
    // e] Define [editPost thunk action] a property of action method using thunk for async actions :
